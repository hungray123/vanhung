    ...
    <div class="container login">
        ...
        <form action="register.php" class="form" method="post" >
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="email" value="<?php echo $email; ?>" placeholder="Nhập Email" name="email">
          </div>
          <div class="form-group">
            <label for="username">Họ và Tên:</label>
            <input type="text" class="form-control"  value="<?php echo $username; ?>" placeholder="Nhập họ và tên" name="username">
          </div>
          <div class="form-group">
            <label for="pwd">Mật Khẩu:</label>
            <input type="password" class="form-control" id="pwd" value="<?php echo $password; ?>" placeholder="Nhập mật khẩu" name="password">
          </div>
          <div class="form-group">
            <label >Nhập lại mật khẩu:</label>
            <input type="password" class="form-control" id="pswd" placeholder="Nhập lại mật khẩu" name="pswd">
          </div>
          ...
          <button type="submit" name="dangky" class="btn btn-primary">Đăng Ký</button>
            <p>Or <a href="Login.php">Đăng nhập</a></p>
