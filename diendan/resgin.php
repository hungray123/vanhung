  ...
  <body>
      <div class="container">
         ...
         <div class="form-group">
                ...
                <!-- <div class="invalid-feedback">Vui lòng điền.</div> -->
        </div>
        <div class="form-group">
          ...
          <div class="form-group">
                      <label for="pwd"><i class="fas fa-unlock-alt"></i> Re-Password:</label>
                      <input type="password" class="form-control" id="pwd" placeholder="Enter password" name="pswd" required>
                      <!-- <div class="valid-feedback">Valid.</div>
                      <div class="invalid-feedback">Vui lòng điền.</div> -->
          </div>
  
  <button type="submit" class="btn btn-outline-success my-2 my-sm-0">Đăng Ký</button>
  <h6></h6>
  <div class="resgin">
  
  <h6> or <a href="logins.php" class=""> Đăng Nhập </a></h6>
  </div>
           </div>
           </div>
           <div class="col-md-6">
